...
- **Đăng ký tài khoản**: Đăng ký với xác thực OTP qua email (3 bước: nhập email, xác nhận OTP, hoàn thành đăng ký)
- **Đăng nhập/Đăng xuất**: Đăng nhập an toàn với mã hóa mật khẩu
- **Quên mật khẩu**: Khôi phục mật khẩu qua email với OTP (3 bước: nhập email, xác nhận OTP, đặt mật khẩu mới)
- **Đổi mật khẩu**: Thay đổi mật khẩu tài khoản
- **Duyệt sản phẩm**: Xem danh sách sản phẩm theo danh mục, tìm kiếm sản phẩm
- **Chi tiết sản phẩm**: Xem thông tin chi tiết, hình ảnh sản phẩm
- **Giỏ hàng**: Thêm/xóa/sửa số lượng sản phẩm, tính tổng tiền tự động
- **Danh sách yêu thích**: Thêm/bớt sản phẩm yêu thích, xem danh sách cá nhân
...
- **Gửi email tự động**: Thông báo xác nhận đơn hàng cho khách hàng, thông báo đơn hàng mới cho admin
- **Xác thực OTP**: Bảo mật đăng ký và khôi phục mật khẩu qua mã OTP email
...
#   S a l e s - M a n a g e m e n t - P r o j e c t  
 